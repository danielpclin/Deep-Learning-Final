...
def train():
    ...
    train_generator = datagen.flow_from_dataframe(dataframe=df, directory="train/data01_train", subset='training',
                                                  ...
                                                  class_mode="multi_output",# classes=alphabet,
    ...
    checkpoint = ModelCheckpoint(checkpoint_path, monitor='val_digit1_accuracy', verbose=1, save_best_only=True, mode='max')
    earlystop = EarlyStopping(monitor='val_digit1_accuracy', patience=10, verbose=1, mode='auto')
